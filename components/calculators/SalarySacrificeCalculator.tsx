...
import { TAX_YEAR, incomeTaxRUK as incomeTax, employeeNI, parseAmount, formatGBP } from '@/lib/uk-tax'
  ...
  return (
    <section className="rounded-lg border border-rule bg-white p-6 sm:p-8">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <p className="metadata uppercase tracking-[0.2em] text-[color:var(--green)]">{TAX_YEAR} tax year · England, Wales &amp; NI</p>
        <ShareButton />
      </div>
      ...
      <details className="mt-8 border-t border-rule pt-6 text-[14.5px] leading-relaxed text-[color:var(--ink-2)]">
        ...
        <div className="mt-3 space-y-2">
          ...
          <p>
            <strong>{TAX_YEAR} bands used:</strong> personal allowance £12,570 (tapered from £100k); basic rate 20% to £50,270; higher rate 40% to £125,140; additional rate 45% above. Employee NI: 8% between £12,570 and £50,270, 2% above.
          </p>
          <p>
