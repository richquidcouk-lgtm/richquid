...
> Rate examples in this guide are historical illustrations, not a live ranking of today’s offers. Check the provider’s current rate, eligibility and terms before applying.
...
3. **What's the FSCS coverage?** Standard £120,000 per eligible person per authorised firm. If you have more than that, split across providers — and check that two separate brand names aren't actually under the same banking licence (Halifax and Bank of Scotland share theirs, for example).
