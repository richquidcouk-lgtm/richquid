...
featuredImage: ""
---
The UK Personal Savings Allowance (PSA) is a **tax-free amount of interest** you can earn from non-ISA savings each tax year. It&rsquo;s **£1,000 for basic-rate taxpayers**, **£500 for higher-rate taxpayers**, and **£0 for additional-rate taxpayers** in 2025/26. Interest above the PSA is taxed at your marginal income tax rate. The PSA only applies to **interest from non-ISA accounts** — ISA interest is separately tax-free and doesn&rsquo;t use the PSA. Banks no longer deduct tax at source; the tax is collected via your tax code (PAYE) or Self Assessment.
...
For 2025/26 with current rates around 4.5%:
