...
If you have rental income, savings interest above the PSA, or dividend income above the £500 allowance, HMRC sometimes codes the estimated tax due into your PAYE code as an [adjustment to your rate band](/guides/adjustment-to-rate-band-meaning) rather than collecting it via Self Assessment. The code adjusts mid-year as HMRC&rsquo;s estimate changes. This can be unsettling but is normal.
