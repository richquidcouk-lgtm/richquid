...
Both easy-access and fixed-rate savings products are protected by the **Financial Services Compensation Scheme** up to £120,000 per person per banking licence. The compensation limit doesn&rsquo;t change based on product type — it depends on which bank holds the money.

If you have more than £120,000 with one banking licence (which can include multiple brands — Halifax and Bank of Scotland share a licence, for example), the excess is unprotected. For sums above £120,000, split across banking licences.
