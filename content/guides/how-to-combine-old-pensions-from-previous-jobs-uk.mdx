---
title: "How to Combine Old UK Pensions from Previous Jobs"
slug: "how-to-combine-old-pensions-from-previous-jobs-uk"
excerpt: "Track down old workplace pensions with the free Pension Tracing Service, then see when consolidating them helps — or hurts."
...
featuredImage: ""
---
To combine old workplace pensions, start by **listing all employers you&rsquo;ve worked for** and contacting each scheme directly — or use the free [Pension Tracing Service](https://www.gov.uk/find-pension-contact-details). Once located, you can consolidate **defined contribution (DC)** pensions into a single SIPP or chosen workplace pension via the formal pension transfer process. **Defined benefit (DB)** pensions worth more than £30,000 require regulated advice before transferring — and usually shouldn&rsquo;t be transferred at all. Consolidation typically takes 4–12 weeks per pot.

This is the process, plus when consolidation helps and when it doesn&rsquo;t.

## Step 1: Find all your old pensions

The typical UK worker changes jobs 6–8 times across a career, leaving a pension at each employer. Many people have 5+ small pots they&rsquo;ve forgotten about.

To track them down:

### Pension Tracing Service (free)

The government runs a free [Pension Tracing Service](https://www.gov.uk/find-pension-contact-details) that helps locate workplace pensions when you know the employer name but not the scheme.
...
They search HMRC&rsquo;s records and give you scheme contact details. The service doesn&rsquo;t tell you the balance or the scheme&rsquo;s current status — just where to write next.

### Contacting old employers directly

If you have HR contact details from a previous employer, ask them for current scheme details. Some employers have moved schemes over the years; they&rsquo;ll usually have records of where your contributions ended up.
...
The free [MoneyHelper Pension Wise service](https://www.moneyhelper.org.uk/) helps over-50s with pension questions but is also useful for general guidance on locating pensions.

## Step 2: Identify each scheme&rsquo;s type
...
Examples: NEST, The People&rsquo;s Pension, Aviva, Legal &amp; General, Standard Life schemes, employer-run group personal pensions.
...
- Simpler if you&rsquo;re happy with the current workplace scheme.
- Some schemes accept transfers in; some don&rsquo;t.
...
1. **Open a SIPP** with your chosen provider (or confirm your current workplace pension accepts transfers in).
2. **Request a transfer** through the receiving provider&rsquo;s system. You give them the old pension&rsquo;s details and they handle the contact with the old scheme.
3. **Sign authorisation** to release the funds.
4. **Wait for transfer.** Typical timeframe: 4–12 weeks. Some schemes are slower, especially smaller occupational schemes.
5. **Confirm receipt** in the new account.
6. **Invest** the consolidated funds in your chosen funds.

The transfer is between providers — you don&rsquo;t handle the cash yourself. The transferred funds retain pension wrapper status throughout.
...
- **You like the workplace scheme&rsquo;s default fund.** Some defaults are well-designed and low-cost.
- **You&rsquo;re close to retirement (under 5 years)** — the cost of transfer fees and time out of market may not be justified.

## What about consolidating in stages?

You don&rsquo;t have to do it all at once. Many people consolidate one or two old pensions per year, picking the smallest or most poorly-performing first. This spreads the admin and lets you assess whether consolidation is working before committing the entire portfolio.
...
Plus he&rsquo;s thinking about opening a SIPP.
...
- Leave the £85,000 L&amp;G pension where it is (it&rsquo;s his current workplace; contributions continue).
...
- [What happens to my workplace pension if I change jobs?](/guides/what-happens-to-my-workplace-pension-if-i-change-jobs)
