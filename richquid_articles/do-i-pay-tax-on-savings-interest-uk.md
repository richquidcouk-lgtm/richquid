...
What&rsquo;s NOT subject to PSA / income tax:

- **ISA interest** — tax-free under ISA rules.
- **Premium Bonds prizes** — tax-free under their own rules.
- **Some NS&I products** (specifically the children&rsquo;s savings versions and certain bond types).
- **Dividend income** — uses separate £500 allowance.

## How banks handle tax (and why it&rsquo;s confusing)

Since April 2016, UK banks **no longer deduct tax at source** on interest paid:

- Interest is paid **gross** (full amount).
- You&rsquo;re responsible for paying any tax owed via your tax code or Self Assessment.
- Banks report interest paid to HMRC annually.

Before 2016, basic-rate tax was deducted automatically by banks. Higher-rate taxpayers had to file Self Assessment to pay additional tax. The 2016 change moved everyone to the &ldquo;gross interest&rdquo; system.

The result: many savers now don&rsquo;t realise interest may be taxable until HMRC catches up via tax code adjustments.
...
Above the PSA, interest is taxed at your marginal rate. The 0% band is sometimes called the &ldquo;savings starting rate&rdquo; for low earners — see below.
...
If the estimate matches your actual interest, you don&rsquo;t owe more at year-end. If there&rsquo;s a discrepancy, HMRC sends a P800 calculation.

### Route 2: Self Assessment

If you&rsquo;re registered for Self Assessment, you report interest on your return. The tax is calculated and paid by 31 January.

This is required if:

- You&rsquo;re already filing for another reason (self-employment, rental income, etc.).
- Your savings interest pushes you over £10,000 (rare but specific HMRC trigger).
- Your tax position is complex enough that PAYE adjustment doesn&rsquo;t work cleanly.
...
This benefit phases out as non-savings income increases. By the time you&rsquo;re earning £17,570 from non-savings sources, the starting rate is gone.
...
Every pound of ISA interest is tax-free. If you have meaningful savings and especially if you&rsquo;re a higher-rate taxpayer, ISA usage is your first line of defense.
...
Use your spouse&rsquo;s PSA too. Transfer some savings to their name (no tax implications between spouses) to use their tax-free allowance.
...
If you&rsquo;re aiming to use savings for retirement and you&rsquo;re close to retirement age, contributing to a pension may be more tax-efficient than holding cash.
...
- [How does premium bonds work and are they worth it?](/how-does-premium-bonds-work-and-are-they-worth-it/)
