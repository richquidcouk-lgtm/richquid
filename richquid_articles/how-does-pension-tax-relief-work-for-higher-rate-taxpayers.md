...
[HMRC: pension tax relief explained](https://www.gov.uk/tax-on-your-private-pension/pension-tax-relief).

## How relief at source works

This is the standard mechanism for SIPPs and most personal pensions:

1. You contribute **net of basic-rate tax**. £80 from your bank account.
2. The pension provider claims **20% basic-rate relief** from HMRC and adds it to your pension. Pension now contains £100.
3. For higher-rate taxpayers, the **extra 20% relief** is reclaimed via **Self Assessment**.

The provider top-up (basic-rate relief) usually arrives 4–8 weeks after the contribution. It happens automatically — you don&rsquo;t need to do anything.
...
1. **Track all your pension contributions** during the tax year. Provider statements usually show this.
2. **File your Self Assessment** (deadline 31 January for online filing).
3. **Report gross pension contributions** on the &ldquo;Pension contributions&rdquo; section of the return. The gross is the £100 figure (your £80 + HMRC&rsquo;s £20).
4. **HMRC extends your basic-rate band** by the gross contribution amount. This shifts £100 of income that would otherwise be taxed at 40% down to the 20% band.
5. **The extra 20% relief** is given as a tax refund or by adjustment to your tax code for the following year.
...
If you don&rsquo;t file Self Assessment, the higher-rate relief is lost. For higher-rate taxpayers, this is a meaningful sum to leave on the table.

## What if I don&rsquo;t file Self Assessment?

If you&rsquo;re a higher-rate taxpayer with PAYE income only and don&rsquo;t normally file Self Assessment, you can still claim the higher-rate pension relief.

Two routes:

### Phone HMRC

Call HMRC&rsquo;s personal tax helpline (0300 200 3300). They can register the relief on your tax code or process a refund without requiring a full Self Assessment registration.
...
A common pattern for higher-rate taxpayers who don&rsquo;t want to file SA: contact HMRC at the start of each tax year with the expected contribution amount, get the relief added to the tax code, and verify at year-end.
...
- The employer&rsquo;s contribution to your pension is in addition.
...
For most higher-rate taxpayers with both options available, salary sacrifice usually beats SIPP — but only if the workplace scheme&rsquo;s fund range and fees are acceptable.
...
See our [£100k tax trap article](/100k-tax-trap-uk/) for the full mechanics.

## How carry-forward extends contributions

If you&rsquo;ve been a member of a registered pension scheme in the last three tax years but didn&rsquo;t use the full annual allowance:
...
If you&rsquo;re in this tapered zone, you can still get higher-rate relief, but on a much smaller allowance. Above the tapered allowance, contributions still get 40% relief but trigger an **annual allowance charge** that essentially claws back the relief — you pay back 40% of the excess contribution.

The detail is in [HMRC: tapered annual allowance](https://www.gov.uk/guidance/pension-schemes-rates).
...
If Charlie didn&rsquo;t file Self Assessment, he&rsquo;d only get the £1,000 basic-rate relief — he&rsquo;d lose £1,000 of higher-rate relief per year. Over 30 years of working, that&rsquo;s £30,000+ of foregone tax savings.
...
- [Can I pay into a pension if I am self employed?](/can-i-pay-into-a-pension-if-i-am-self-employed/)
