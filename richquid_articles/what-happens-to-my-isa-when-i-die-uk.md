...
# What happens to my ISA when I die in the UK?
...
A 2018 change (the &ldquo;continuing ISA&rdquo; rules) introduced tax-free protection on the ISA for a limited period after death:
...
- No further contributions can be made by anyone (the deceased can&rsquo;t, the estate can&rsquo;t, beneficiaries can&rsquo;t).
- The provider continues to hold the funds in the ISA structure until the estate&rsquo;s executor instructs them.
...
- The APS is equal to the value of the deceased&rsquo;s ISA at the higher of: date of death, or the date assets transfer to the spouse.
- This is in addition to the spouse&rsquo;s own £20,000 annual allowance.
...
This means a surviving spouse can effectively keep the family&rsquo;s ISA wealth inside ISA wrappers, even though the technical transfer leaves the wrapper for a moment.
...
## What if there&rsquo;s no surviving spouse?
...
- The beneficiaries hold the assets as normal taxable investments going forward — they don&rsquo;t inherit the ISA wrapper.
...
- He&rsquo;s widowed; spouse died years before, so her unused nil-rate band transfers to his estate. Combined nil-rate band: £650,000.
- His estate is below the combined nil-rate band — no IHT.
- The £100,000 ISA passes to his children, who receive it as a £100,000 lump sum (no further wrapper since he wasn&rsquo;t married at death).
...
- Use the **pension** as a primary tax-efficient wrapper, especially for funds you don&rsquo;t need to access before age 60.
...
If you&rsquo;re executor of an estate that includes ISAs:
...
5. **Instruct the provider** how to distribute the ISA — typically to the executor&rsquo;s solicitor or directly to beneficiaries per the will.
...
## What if I&rsquo;m the spouse — can I just keep the deceased&rsquo;s ISA?

Not directly. The ISA wrapper is personal — it has the deceased&rsquo;s NI number on it. The proper sequence:

1. Inherit the funds (or assets) from the deceased&rsquo;s ISA.
2. The funds come into your own bank account / wealth.
3. Use the APS to put them back into ISA wrappers (this can be done with the deceased&rsquo;s provider or any other ISA provider — your choice).
...
- [Can I inherit my spouse ISA allowance?](/can-i-inherit-my-spouse-isa-allowance/)
