...
# Does an ISA count toward my Personal Savings Allowance?
...
The two systems don&rsquo;t interact. Consider three scenarios:

### Scenario 1: All cash in a regular savings account

You&rsquo;re a basic-rate taxpayer with £40,000 in a regular savings account at 4.5%:
...
£20,000 in cash ISA at 4.5% = £900 interest, tax-free.
£20,000 in regular savings at 4.5% = £900 interest, all within £1,000 PSA, tax-free.

Total: £1,800 interest, all tax-free. Same effective outcome as Scenario 2 because the PSA covers the non-ISA interest.

This is why for basic-rate taxpayers with modest savings, the ISA wrapper sometimes isn&rsquo;t worth the admin — the PSA covers them anyway. The ISA becomes more valuable as:
...
- Bank A: £200 interest.
- Bank B: £400 interest.
- Bank C savings ISA: £300 interest (ISA — doesn&rsquo;t count toward PSA).
...
## What counts as &ldquo;savings interest&rdquo; for the PSA?
...
What doesn&rsquo;t use the PSA:

- ISA interest (own tax-free framework).
- Dividends (use the separate Dividend Allowance).
- Premium Bonds prizes (tax-free under their own rules, don&rsquo;t use PSA).
- Foreign-source interest paid abroad (treated under foreign income rules, not PSA directly).

For the full HMRC position, see [gov.uk: Personal Savings Allowance](https://www.gov.uk/apply-tax-free-interest-on-savings).
...
- £15,000 in cash ISA: £675 interest → tax-free under ISA, doesn&rsquo;t use either allowance.
...
1. **Always fill the LISA first if you&rsquo;re eligible and using it for first-home or retirement** (25% bonus is unmatched).
2. **Fill the cash ISA if you have more cash savings than your PSA can cover** (typically £15,000–£25,000+ depending on tax band and interest rate).
3. **Fill the stocks &amp; shares ISA for long-term investments** (CGT and dividend allowances are much smaller than PSA, so equity returns benefit more from ISA wrapping).
4. **Beyond the ISA**: cash above PSA needs careful tax handling; long-term investments outside ISA face CGT.
...
*This guide is information, not regulated financial advice. Tax bands and allowances can change between budgets — confirm current figures on [gov.uk](https://www.gov.uk/) before relying on specific numbers.*
