---
meta_title: "Can I Transfer a Cash ISA to a Stocks & Shares ISA?"
meta_description: "Yes. Use the official transfer process to move from cash to stocks & shares ISA without using current-year allowance. The mechanics, timing and tax-free status."
pillar: "ISAs"
source_keyword: "can I transfer a cash ISA to a stocks and shares ISA"
---
...
The cash ISA provider sends the money directly to the new stocks &amp; shares ISA provider. The funds are tagged as &ldquo;transfer in&rdquo; — they retain their ISA wrapper status, don&rsquo;t affect the current year&rsquo;s £20,000 contribution limit, and don&rsquo;t lose any tax-free history.

The new provider initiates the transfer with the old provider — you don&rsquo;t touch the cash.

### 2. Withdraw and re-deposit (almost never use this)

You take the cash out of the ISA (it loses the wrapper status), then deposit it as a fresh contribution into the new ISA. The deposit counts against this year&rsquo;s £20,000 allowance, regardless of how much you withdrew.
...
1. **Open the new stocks &amp; shares ISA** with your chosen provider (Vanguard, Hargreaves Lansdown, AJ Bell, Trading 212, InvestEngine, etc.). The new account doesn&rsquo;t need to receive a new contribution — it can be opened ready to receive a transfer.
2. **Request the transfer in the new provider&rsquo;s system.** You provide the old cash ISA provider&rsquo;s details, account number and the amount to transfer (full or partial).
...
You don&rsquo;t touch the cash. The transfer happens between the two providers.

## Will I lose interest while the cash is moving?

During the transfer period, the cash ISA stops paying interest (because the funds have been earmarked for transfer) and the stocks &amp; shares ISA doesn&rsquo;t pay interest (it&rsquo;s for investment, not cash savings). For 5–15 working days, you earn nothing on the transferring cash.
...
The new flexibility (introduced with the April 2024 reform — see our [multiple ISAs article](/can-i-pay-into-two-isas-in-the-same-tax-year/)) makes this kind of mid-year restructure much easier.

## When transferring from cash to stocks &amp; shares makes sense

A few situations where the move is worth considering:

- **Long time horizon.** Money you genuinely won&rsquo;t need for 5+ years often performs better in equities than in cash, even after volatility.
...
- **Better tax efficiency.** Inside the ISA wrapper, both cash and investments are tax-free in the UK. But interest above the Personal Savings Allowance (outside an ISA) is taxable while ISA interest isn&rsquo;t. The relative case for sheltering investments inside an ISA is even stronger than for cash, because investment dividends and gains are also tax-free.

When the move doesn&rsquo;t make sense:

- **You need the money within 5 years.** Equities can drop 30%+ in a recession; you don&rsquo;t want to be selling at the bottom to fund a planned expense.
- **You&rsquo;re uncomfortable with volatility.** If a 20% paper loss would cause you to panic-sell, stay in cash and accept the lower return.
...
The penalty is taken from the transferred balance — you don&rsquo;t pay it separately.

Calculate before transferring:

- Penalty cost: 90 days × £20,000 × 4.5% / 365 = ~£221.
- If the new stocks &amp; shares ISA returns 5% over the next year on the same £20,000, that&rsquo;s £1,000. Net benefit: £779 in year 1, then continued tax-free growth.

If the maturity is within 6 months and the penalty is large, waiting may be smarter.

## What if my old provider doesn&rsquo;t play ball?

Occasionally, transfers stall. Common reasons:

- Identity verification mismatch (name, address, NI number doesn&rsquo;t match).
