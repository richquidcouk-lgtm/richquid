---
meta_title: "What is the Annual Allowance for Pensions? (UK 2026/27)"
meta_description: "£60,000 standard annual allowance for 2026/27. Tapered for high earners (down to £10,000), MPAA for flexible drawdown. Carry-forward of unused allowance."
pillar: "Pensions"
source_keyword: "what is the annual allowance for pension contributions"
---
...
If you&rsquo;re a high earner, the standard £60,000 is reduced via the **tapered annual allowance**.
...
If you&rsquo;ve **flexibly accessed a DC pension** — i.e. taken any taxable income beyond the 25% tax-free lump sum — you trigger the MPAA.

- **MPAA: £10,000** per year for DC contributions.
- Applies to defined contribution pensions only.
- Doesn&rsquo;t affect defined benefit accrual (which has its own input rules).
...
- Taking a DB pension (DB doesn&rsquo;t trigger MPAA on the recipient).
...
For someone still working and contributing to a pension, the MPAA is a serious constraint. Avoid flexibly accessing pension income until you&rsquo;re ready to stop building.

## Carry-forward of unused allowance

If you didn&rsquo;t use the full annual allowance in any of the previous three tax years, you can **carry forward** the unused amount.
...
- Carry-forward doesn&rsquo;t apply to MPAA — once triggered, DC contributions are capped at £10,000.
...
[HMRC: pension annual allowance and carry-forward](https://www.gov.uk/guidance/pension-schemes-rates).

## The annual allowance charge

If you exceed the annual allowance and don&rsquo;t qualify for carry-forward:

- The excess is added to your taxable income for the year.
- It&rsquo;s taxed at your marginal rate (20%, 40% or 45%).
- This effectively claws back the tax relief on the excess contribution.

You report the excess on your Self Assessment and pay the additional tax. It&rsquo;s administratively painful but not catastrophic if managed.

For very large excesses (over £40,000), you can elect for the pension scheme to pay the charge directly from your pension pot (called &ldquo;Scheme Pays&rdquo;) — this avoids needing to find the cash yourself.

## What about defined benefit (DB) pensions?

DB pensions don&rsquo;t have a simple cash contribution — they accrue a future income entitlement. The annual allowance still applies to DB, but it&rsquo;s calculated as:

- **Pension Input Amount (PIA)**: the increase in your annual DB benefit, multiplied by 16, plus any increase in your lump sum entitlement, minus the previous year&rsquo;s benefit indexed for CPI.
- This represents the &ldquo;contribution equivalent&rdquo; for annual allowance purposes.

For most NHS, Teachers, Police and Civil Service pension members, the PIA is calculated automatically by the scheme and reported annually. You don&rsquo;t need to do the maths yourself — the scheme tells you.
