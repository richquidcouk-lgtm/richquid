---
meta_title: "Do I Need to Register as Self-Employed for a Side Hustle?"
meta_description: "If side hustle income exceeds £1,000/year you must register for Self Assessment with HMRC by 5 October. The process, deadlines and penalties explained."
pillar: "Tax and side income"
source_keyword: "do I need to register as self employed for a side hustle"
---

# Do I need to register as self-employed for a side hustle?

Yes — if your **gross side hustle income exceeds £1,000 per tax year**, you must register for **Self Assessment** with HMRC. The deadline is **5 October following the end of the tax year** in which you first crossed the threshold. Failing to register on time triggers penalties starting at £100. Registration is free and takes about 10–20 minutes online. You don&rsquo;t need to set up a limited company unless you specifically want to — most side hustlers operate as sole traders, which means &ldquo;self-employed&rdquo; in HMRC&rsquo;s language.
...
- **You&rsquo;re a high earner** (PAYE income above £150,000).
...
The framework is at [gov.uk: register for Self Assessment](https://www.gov.uk/register-for-self-assessment).
...
## What &ldquo;self-employed&rdquo; means in this context

For tax purposes, &ldquo;self-employed&rdquo; covers anyone earning income from non-employment activities. This includes:
...
You don&rsquo;t need to **set up a limited company** to be self-employed. Most side hustlers stay as sole traders for simplicity.

The line between &ldquo;employed&rdquo; and &ldquo;self-employed&rdquo;:
...
If you&rsquo;re unsure which category you fall into for a specific role, see [HMRC employment status guidance](https://www.gov.uk/employment-status).
...
Go to [gov.uk: register for Self Assessment](https://www.gov.uk/register-for-self-assessment) and apply online.
...
- **Type of business** you&rsquo;re running (brief description).
...
HMRC issues a **Unique Taxpayer Reference (UTR)** by post within **10 working days**. The UTR is a 10-digit number you&rsquo;ll use for all future communication with HMRC.

You&rsquo;ll also receive a **letter explaining how to file Self Assessment online**.

### Step 3: Set up online filing

Once you have the UTR:

- Set up your **online Self Assessment account** at [gov.uk: file online](https://www.gov.uk/file-your-self-assessment-tax-return).
- The first time you log in, you go through identity verification and confirm your activation code from HMRC.

You&rsquo;re now ready to file when the tax year ends.

## What happens after registration

After you&rsquo;ve registered:

- HMRC expects you to file a Self Assessment return for the tax year in which you crossed £1,000 — **even if you later don&rsquo;t need to file**.
- Future tax years: HMRC will issue a reminder each spring with a Notice to File. You then complete and submit by 31 January.

If you stop self-employed activity, you should **deregister** by informing HMRC that you&rsquo;re no longer trading. Otherwise, HMRC keeps expecting returns.

## Penalties for late registration

If you don&rsquo;t register on time:

- **No specific late-registration penalty** if you register late but still file the return on time.
- **Late filing penalty** if you miss the 31 January deadline because you didn&rsquo;t register: starts at £100, increases over time.
- **Failure to notify penalty** if HMRC later identifies undeclared income — typically 30%+ of the tax owed.

The biggest risk is the **failure to notify** penalty for ignoring side hustle income for years. HMRC&rsquo;s data sharing with online platforms (since 2024) makes this easier to identify.
...
When registering, HMRC may still ask about Class 2 status — usually to confirm you understand it&rsquo;s voluntary.
...
You don&rsquo;t need to register. The trading allowance covers your income.
...
*This guide is information, not regulated financial advice. UK tax rules change between budgets — confirm on [gov.uk](https://www.gov.uk/) before acting.*
