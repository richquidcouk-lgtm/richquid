---
meta_title: "What Happens to My Workplace Pension When I Change Jobs?"
meta_description: "Old workplace pensions stay invested and accessible to you forever. How they work after you leave, whether to transfer or leave them, and the trace tools."
pillar: "Pensions"
source_keyword: "what happens to my workplace pension if I change jobs"
---

# What happens to my workplace pension if I change jobs?

When you leave an employer, the workplace pension you built up stays open and continues to be invested — it&rsquo;s yours. You stop receiving employer contributions, you can&rsquo;t pay in further (in most schemes), but the existing pot keeps growing through investment returns until you access it from age 55+ (rising to 57 from April 2028). You can transfer it to a SIPP, your new employer&rsquo;s scheme, or leave it where it is.
...
1. **The workplace pension stays in your name.** You don&rsquo;t lose it.
2. **Contributions stop.** Neither you nor the employer can typically pay in further.
3. **Investment continues.** The funds in your pot stay invested and grow.
4. **Fees usually change.** Many workplace schemes have a &ldquo;pricing tier&rdquo; for active employees that switches to a higher tier for &ldquo;deferred members&rdquo; — sometimes adding 0.10–0.50% to the annual fee.
5. **You become a &ldquo;deferred member&rdquo;** of the scheme until you access the pension or transfer it out.
...
The simplest path. The old pension stays with the old employer&rsquo;s scheme provider. You receive annual statements; investment continues automatically.

Pros:

- No transfer paperwork.
- No risk of losing scheme-specific benefits.
- Cost is whatever the scheme&rsquo;s deferred-member fee is.
...
- Often the current scheme&rsquo;s active-employee fees apply to the transferred-in funds.
...
- **Pension Tracing Service** (free): [gov.uk pension trace](https://www.gov.uk/find-pension-contact-details).
...
When fully rolled out, this dramatically simplifies tracking old pensions. As of 2025/26, the system is partial — some providers connected, others still being onboarded. Check [MoneyHelper&rsquo;s Pensions Dashboard page](https://www.moneyhelper.org.uk/) for the current status.
...
See [our guide on what happens to your pension if you leave the UK](/what-happens-to-my-pension-if-i-leave-the-uk-permanently/).

## When transferring is worth doing

A few cases where transferring an old workplace pension makes sense:

1. **Old DC scheme with high fees.** A 1.0%+ deferred-member fee can erode returns significantly over decades. Modern SIPPs often charge 0.30% or less.
2. **Multiple small pots to consolidate.** 5 pots of £20,000 each = £100,000 across 5 providers. One SIPP makes admin much easier.
3. **Poor fund choice in the old scheme.** If the old scheme&rsquo;s default fund underperforms or you don&rsquo;t like it, transferring to a SIPP with better options is worthwhile.

When it isn&rsquo;t:

1. **Old DB scheme**. Don&rsquo;t transfer.
2. **Pension with unique features** (guaranteed annuity rates, protected tax-free cash, with-profits accumulation). Check before transferring.
3. **Small pension under £10,000** with a particularly low transfer-out fee — might not justify the admin.
...
- **Move it to her new employer&rsquo;s pension** if they accept transfers — likely worthwhile if active-employee fees are lower.
- **Move it to a SIPP** to consolidate with another old pension she has from a previous role.

She chooses the SIPP route, transfers both old pensions (£55,000 + £18,000 = £73,000 total) into a Vanguard SIPP with a single global equity index fund. New employer&rsquo;s pension receives her ongoing contributions in parallel. Reviews both annually.

## Internal links

- [How to combine old pensions from previous jobs UK](/how-to-combine-old-pensions-from-previous-jobs-uk/)
