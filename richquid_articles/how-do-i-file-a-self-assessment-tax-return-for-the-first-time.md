...
If none apply, you don&rsquo;t need to file. Check [HMRC&rsquo;s &ldquo;do I need to file&rdquo; tool](https://www.gov.uk/check-if-you-need-tax-return).
...
You&rsquo;ll also receive a letter explaining how to file online.

## Step 3: Set up your online tax account

Once you have the UTR:

1. Go to [gov.uk: file your Self Assessment](https://www.gov.uk/file-your-self-assessment-tax-return).
2. Sign in with your Government Gateway ID (create one if needed).
3. Use the UTR + activation code (from HMRC&rsquo;s letter) to activate online filing.
...
You&rsquo;ll receive an **on-screen confirmation** and a confirmation email. Keep this for your records.
...
- **Bank transfer using HMRC&rsquo;s payment details** (see your online account for the reference number).

You must use your **UTR followed by &ldquo;K&rdquo;** as the payment reference (e.g. 1234567890K). Without this, HMRC may not allocate the payment correctly.
...
| 3 months late | Additional £10/day for up to 90 days (£900 max) |
...
- **First payment on account**: 50% of last year&rsquo;s tax bill, due **31 January** alongside the balancing payment.
...
This cash-flow shock catches many first-time filers off-guard. Budget for 1.5× your first year&rsquo;s tax bill in January.
...
Gathering documents and figuring out the form takes 1–4 hours typically. Don&rsquo;t start the day before the deadline.

### 2. Not claiming all allowable expenses

For self-employed: don&rsquo;t forget mileage, share of home utilities, professional subscriptions, training costs, equipment.

### 3. Missing the higher-rate pension relief

If you contributed to a personal pension and you&rsquo;re a higher-rate taxpayer, claim the additional relief through Self Assessment.
...
You&rsquo;ll receive a **tax calculation (SA302)** confirming the return — useful for future reference (and required by some mortgage lenders).
...
*This guide is information, not regulated financial advice. UK Self Assessment rules can change — confirm on [gov.uk](https://www.gov.uk/) before relying on specific guidance.*
