---
meta_title: "What Happens to My LISA if I Buy a House Over £450k?"
meta_description: "If your home costs over £450,000 the LISA can't be used penalty-free. Withdrawing triggers a 25% penalty on the whole amount. Workarounds and timing explained."
pillar: "ISAs"
source_keyword: "what happens to my LISA if I buy a house over 450k"
---
...
- This cap applies to the **whole property**, not to the LISA holder&rsquo;s share. For joint purchases, the combined price still needs to be £450k or less.
- The cap has not been raised since the LISA launched in **2017**.
- Inflation since 2017 has eroded the cap&rsquo;s reach, particularly in London and the South East — a £450,000 property in 2017 is roughly £600,000 today in many regions.
...
This is not the same as just &ldquo;losing the bonus&rdquo;. The maths is:
...
## What counts as a &ldquo;qualifying&rdquo; first-home purchase?

To use the LISA penalty-free for a first home, you need ALL of the following:

1. **First-time buyer**: you&rsquo;ve never owned property anywhere in the world.
...
All of these must be met. Failing any one of them means the withdrawal isn&rsquo;t qualifying.

The buyer requirement is usually the trickiest. If you&rsquo;re buying jointly and your partner has owned property before, the partner&rsquo;s share isn&rsquo;t a first-time purchase — but **your LISA can still be used** if you personally meet the first-time buyer test. The £450k cap still applies to the whole property.
...
If you&rsquo;re planning to buy in a high-cost area, the cap can become binding quickly, particularly if the housing market continues to outpace the (frozen) £450k figure.

## What if my offer is accepted at £450,001?

The cap is an **&ldquo;at or below £450,000&rdquo;** test. £450,000 is allowed. £450,001 is not.

Real-world scenarios:

- **Negotiate the price down by £1**. Sometimes works, often doesn&rsquo;t.
- **Negotiate down by more** if seller is flexible.
- **Pay over £450,000 from non-LISA funds** — buy the property for £465,000 with £15,000 of your own savings on top of a £450,000-priced offer. This doesn&rsquo;t work either — the contract price is the property cost, not just what you fund from the LISA.
...
Treat it as a retirement vehicle. You can leave the LISA invested and access it tax-free from age 60. The 25% bonus still applies to contributions; the 25% penalty doesn&rsquo;t apply if you wait until 60.
...
If you&rsquo;re close to the £450k cap and the LISA bonus is material to your deposit, consider whether a slightly cheaper property would work. The £1,000/year bonus over 5 years of saving = £5,000 of free money. Worth weighing against the property price flexibility.

### 3. Accept the penalty as the cost

If you&rsquo;ve already accumulated significant LISA funds and now need to buy over £450k, take the penalty hit. £3,750 returned per £4,000 contributed isn&rsquo;t great but isn&rsquo;t catastrophic — especially if the alternative is having less deposit and a higher mortgage rate.
...
The LISA is for **first-time buyers** only. If you&rsquo;ve already owned property, the LISA can&rsquo;t be used for buying another home penalty-free. The exception: if you&rsquo;re a joint buyer where only your partner has owned property before, your LISA can still be used (if you yourself are a first-time buyer).

For divorcees or those leaving a previous joint ownership, the rules are strict — once you&rsquo;ve owned property, you&rsquo;re no longer a first-time buyer for LISA purposes, even if you&rsquo;ve sold the home and have no current property ownership.
...
*This guide is information, not regulated financial advice. The LISA penalty and property cap interact with mortgage, SDLT and inheritance rules in ways that vary by individual circumstance — speak to a regulated adviser when making a specific decision.*
