...
- **But it&rsquo;s taxed as income** at the beneficiary&rsquo;s marginal rate when withdrawn.
...
The takeaway: the beneficiary&rsquo;s tax band when drawing matters significantly. Spreading withdrawals over years can save tens of thousands of tax.

## How to nominate beneficiaries

Most pensions allow you to nominate beneficiaries via:

- **Expression of Wish form** (sometimes called &ldquo;nomination of beneficiaries&rdquo;) — submitted to the pension provider.
- Online via your pension provider&rsquo;s portal.
- Updated whenever your circumstances change (marriage, divorce, new children).

A few key points:

- The nomination is **not legally binding** in many UK schemes — but trustees almost always follow the nomination unless there&rsquo;s a strong reason not to.
- The nomination is **separate from your will** — pension typically doesn&rsquo;t pass via the will.
...
Failing to nominate a beneficiary doesn&rsquo;t mean the pension is lost — the pension trustees will use their discretion, usually paying to the spouse first, then children. But explicit nomination is much cleaner.
...
- The pension doesn&rsquo;t count toward your £325,000 nil-rate band.
- IHT (40% above nil-rate) doesn&rsquo;t apply to the pension.
...
- Plus a **spouse&rsquo;s pension** — often 50–75% of the pension you would have received.
...
- Death benefits depend on the scheme&rsquo;s specific rules.
- Often a spouse&rsquo;s pension applies.
- Lump sum is sometimes less generous than for active members.

### After starting to draw a DB pension

- Most schemes pay a **survivor&rsquo;s pension** — typically 50% of the original pension — to the spouse for life.
- If you took a **guaranteed minimum period option** (e.g. &ldquo;5-year guarantee&rdquo;), payments continue to your estate for the remainder of that period.

DB scheme rules vary considerably. Always check your specific scheme&rsquo;s booklet or contact the administrator.

## What about the State Pension on death?

The State Pension stops on death, with some exceptions:

- **Spouse&rsquo;s State Pension**: a surviving spouse who reached State Pension age before 6 April 2016 may inherit a portion of the deceased&rsquo;s additional State Pension (under the pre-2016 rules).
- **New State Pension (post-2016)** is broadly a personal entitlement — there&rsquo;s limited spouse inheritance.
- **Bereavement support payments** may apply for surviving spouses or civil partners under State Pension age.

The rules for State Pension inheritance are complex and depend on age and pre/post-2016 status. The [gov.uk State Pension inheritance page](https://www.gov.uk/state-pension-through-partner) has the detail.
...
Ahmed, 65, has £600,000 in a SIPP plus £400,000 of other assets (house, ISA, savings). He&rsquo;s widowed. Two adult children.
