---
meta_title: "Can I Pay Into a Pension if I'm Self-Employed? (UK 2025/26)"
meta_description: "Yes — self-employed people can open a SIPP and get tax relief on contributions up to £60,000/year or 100% of profits. How tax relief flows for the self-employed."
pillar: "Pensions"
source_keyword: "can I pay into a pension if I am self employed"
---

# Can I pay into a pension if I am self-employed?

Yes. Self-employed people in the UK can open a **personal pension** — most often a Self-Invested Personal Pension (SIPP) — and pay contributions with tax relief, up to the **lower of £60,000 or 100% of relevant UK earnings** in 2025/26. Without a workplace pension to auto-enrol you, the responsibility for retirement saving falls entirely on you. Tax relief works the same way as for employed pension contributions — basic-rate (20%) added automatically by the provider, higher/additional rate reclaimed via Self Assessment.

This is the full picture for self-employed pension contributions in 2025/26.

## What &ldquo;self-employed&rdquo; means here
...
If you&rsquo;re a director-shareholder of a limited company, you have additional options (employer contributions from the company can be very tax-efficient) — see below.
...
If you have a workplace pension from a previous employed role, you can usually continue paying into it as a self-employed person — but check with the scheme. Many won&rsquo;t accept new contributions from non-employees.
...
1. You contribute net of basic-rate tax. For each £80 you pay in, HMRC adds £20 (the basic-rate relief), giving £100 gross in the pension.
2. The provider claims the basic-rate relief from HMRC and adds it to your pension within a few weeks.
3. Higher-rate (40%) and additional-rate (45%) taxpayers claim the extra relief via Self Assessment.
...
The relief is claimed in the Self Assessment year — for 2025/26 SA, you&rsquo;re claiming relief on contributions made in 2025/26.

## How much can I contribute?

The maximum tax-relievable contribution is the **lower of**:

- **£60,000 per year** (the standard annual allowance for 2025/26), or
- **100% of your relevant UK earnings**.

For a sole trader, &ldquo;relevant UK earnings&rdquo; is your **net self-employed profit** for the tax year.
...
- Excess contributions don&rsquo;t get tax relief.
...
Set up a direct debit for £200–£500/month into the SIPP. Builds the habit, captures basic-rate relief, doesn&rsquo;t depend on annual top-ups.

### Top up at year-end with surplus

If the year has been good, contribute a larger lump sum before 5 April to capture this year&rsquo;s allowance.
...
- The contribution is a deductible business expense for corporation tax purposes (reducing the company&rsquo;s corporation tax liability).
...
Self-employed people should also focus on their NI record for State Pension purposes. Class 4 NI doesn&rsquo;t accumulate State Pension entitlement on its own — Class 2 (now voluntary) does.

A self-employed person who pays only Class 4 (and doesn&rsquo;t pay voluntary Class 2 or otherwise have credits) may have gaps in their NI record. Check your [State Pension forecast](https://www.gov.uk/check-state-pension) annually and consider voluntary Class 2 contributions to fill gaps.
